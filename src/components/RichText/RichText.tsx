...
function renderInlineNodes(text: string, links: ArticleLink[]): React.ReactNode[] {
...
function RichText({ text, links = [], className = 'section-box__content' }: RichTextProps) {
